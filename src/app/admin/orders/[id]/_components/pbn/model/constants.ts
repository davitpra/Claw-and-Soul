...
/**
 * Feature flag de la guía de mezcla de pinturas.
 *
 * La guía usa `@/lib/pbn/paintMixing`, que mezcla pigmentos con `spectral.js`
 * (Kubelka-Munk, licencia MIT — apto para uso comercial). Con el flag en
 * `false`, `usePaintMixing` no invoca el import dinámico de `paintMixing`, por
 * lo que la matemática de mezcla se mantiene fuera del bundle inicial.
 */
export const ENABLE_MIXING_GUIDE = true;
