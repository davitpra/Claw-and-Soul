    ...
    <div className="flex min-h-screen w-full">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white z-10">
          ...
          <p className="text-lg opacity-90 drop-shadow-sm max-w-md">
            Join over 10,000 pet parents creating personalized memories that
            last a lifetime.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-[480px] w-full flex flex-col gap-8">
          ...
          {/* Terms */}
          <p className="text-xs text-center text-[#6c7a7f] leading-relaxed">
            By clicking &quot;Create Account&quot;, you agree to Claw and Soul&apos;s{" "}
