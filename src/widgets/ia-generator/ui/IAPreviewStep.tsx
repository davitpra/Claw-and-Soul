            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuB5cv5UXI6n4PI_8Ya3Rh-X74jZ0SQxJ7Qej67Loo65G5WVzAOaUkAz3Qfv_imuG0fHz7JgNJuAsTrN1JwDJKKC15QKiuOLVPPRNIBtu7zOtSRPCq628kmg0QnozpKxhCaAqPq7452YJ7RMTTj163JOWTy-QiCukOi_DN-l4a3WJ4b_Dbif5ejxxXmCn121FbjWsEWvZunkUmtiHLTZglsSsOblRw4advHALpiRw07aeJDprARXA7fghypANKLQycDJ-aZWytp98Kn5",
                },
                {
                  style: "Vibrant Pop Art",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuB5cv5UXI6n4PI_8Ya3Rh-X74jZ0SQxJ7Qej67Loo65G5WVzAOaUkAz3Qfv_imuG0fHz7JgNJuAsTrN1JwDJKKC15QKiuOLVPPRNIBtu7zOtSRPCq628kmg0QnozpKxhCaAqPq7452YJ7RMTTj163JOWTy-QiCukOi_DN-l4a3WJ4b_Dbif5ejxxXmCn121FbjWsEWvZunkUmtiHLTZglsSsOblRw4advHALpiRw07aeJDprARXA7fghypANKLQycDJ-aZWytp98Kn5",
                },
              ].map((v, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl p-4 shadow-sm border border-transparent hover:border-primary/20 hover:shadow-md transition-all flex flex-col group h-full"
                >
                  ...
                  <h3 className="text-center font-bold text-slate-dark mb-3 text-lg">
                    {v.style}
                  </h3>
              ...
              {products.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`h-full bg-white rounded-2xl p-4 shadow-sm border-2 transition-all hover:shadow-md flex flex-col ${
                        isSelected
                    ...
                    >
                      <div className="aspect-[16/10] bg-[#F5F5F0] rounded-xl mb-4 flex items-center justify-center p-6 relative overflow-hidden">
                        ...
                        <div className="absolute top-3 right-3 text-primary opacity-0 peer-checked:opacity-100 transition-opacity z-20">
                          <span className="material-symbols-outlined text-3xl bg-white rounded-full">
                            check_circle
                          </span>
                        </div>
                      </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-xs text-slate-dark/50 font-medium">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="hidden md:block text-right mr-2">
              <span className="block text-xs text-slate-dark/60 uppercase font-black tracking-widest">
                Total
              </span>
              <span className="block text-xl font-black text-slate-dark tracking-tight">
                {products.find((p) => p.name === selectedProduct)?.price ||
                  "$89.99"}
              </span>
            </div>
            <button className="w-full md:w-auto min-w-[260px] flex items-center justify-center gap-2 rounded-xl bg-primary hover:bg-primary-dark text-white px-8 py-3.5 text-lg font-bold transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
